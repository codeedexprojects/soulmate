    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('executive', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='executives.executives')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executive', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocked_executives', to='executives.executives')),
