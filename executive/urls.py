...
urlpatterns = [
    ...
    path('calls-accept/<str:zegocloud_call_id>/', AcceptCallView.as_view(), name='accept_call'), 

    path('exe-call-history/<int:executive_id>/', ExecutiveCallHistoryListView.as_view(), name='call-history'),
